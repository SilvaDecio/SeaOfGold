    ...
    class Settings : State
    {
        ...
        public Settings(StateManager Father)
        {
            ...
            if (StateManager.HasVibrationControl)
            {
                ...
                ("Buttons/Pause/VibrationOn"), new Vector2(330, 120));
            }
            else
            {
                VibrationButton = new Button(Manager.Game.Content.Load<Texture2D>
                ("Buttons/Pause/VibrationOff"), new Vector2(330, 120));
            }

            # region Sliders

            SongSlider = new Slider(Manager.Game.Content.Load<Texture2D>("Slider"), Manager.Game.Content.Load<Texture2D>("SliderBar"),
                MediaPlayer.Volume * 10, new Vector2(), new Vector2(90, 215), 90, string.Empty);

            SongSlider.Position = new Vector2(90 + (SongSlider.Value * 10), 150);
            ...
            SoundEffectSlider = new Slider(Manager.Game.Content.Load<Texture2D>("Slider"), Manager.Game.Content.Load<Texture2D>("SliderBar"),
                SoundEffect.MasterVolume * 10, new Vector2(), new Vector2(600, 215), 600, string.Empty);

            SoundEffectSlider.Position = new Vector2(600 + (SoundEffectSlider.Value * 10), 150);
